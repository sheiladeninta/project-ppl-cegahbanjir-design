    ...
    <form action="{{ route('admin.weather.parameters.update', $parameter) }}" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="number" step="0.01" min="0" id="threshold_low" name="threshold_low" value="{{ old('threshold_low', $parameter->threshold_low) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('threshold_low') border-red-500 @enderror" required>
                @error('threshold_low')
            ...
            <div>
                ...
                <input type="number" step="0.01" min="0" id="threshold_medium" name="threshold_medium" value="{{ old('threshold_medium', $parameter->threshold_medium) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('threshold_medium') border-red-500 @enderror" required>
            ...
            <div>
                ...
                <input type="number" step="0.01" min="0" id="threshold_high" name="threshold_high" value="{{ old('threshold_high', $parameter->threshold_high) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('threshold_high') border-red-500 @enderror" required>
        ...
        <div>
            ...
            <input type="number" min="1" id="consecutive_days" name="consecutive_days" value="{{ old('consecutive_days', $parameter->consecutive_days) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('consecutive_days') border-red-500 @enderror" required>
