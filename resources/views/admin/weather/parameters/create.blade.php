...
<div class="bg-white shadow rounded-lg p-6">
    <form action="{{ route('admin.weather.parameters.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <select id="weather_station_id" name="weather_station_id" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-indigo-200 @error('weather_station_id') border-red-500 @enderror">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
                ...
                <input type="number" step="0.01" min="0" id="threshold_low" name="threshold_low" value="{{ old('threshold_low') ?? 20 }}" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-indigo-200 @error('threshold_low') border-red-500 @enderror">
                @error('threshold_low')
                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <input type="number" step="0.01" min="0" id="threshold_medium" name="threshold_medium" value="{{ old('threshold_medium') ?? 50 }}" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-indigo-200 @error('threshold_medium') border-red-500 @enderror">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
                ...
                <input type="number" step="0.01" min="0" id="threshold_high" name="threshold_high" value="{{ old('threshold_high') ?? 100 }}" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-indigo-200 @error('threshold_high') border-red-500 @enderror">
            ...
            <div>
                ...
                <input type="number" step="0.01" min="0" id="threshold_very_high" name="threshold_very_high" value="{{ old('threshold_very_high') ?? 150 }}" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-indigo-200 @error('threshold_very_high') border-red-500 @enderror">
        ...
        <div class="mb-4">
            ...
            <input type="number" min="1" id="consecutive_days" name="consecutive_days" value="{{ old('consecutive_days') ?? 1 }}" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-indigo-200 @error('consecutive_days') border-red-500 @enderror">
